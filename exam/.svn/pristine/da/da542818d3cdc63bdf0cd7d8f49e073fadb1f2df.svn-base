...
<html>
                                        ...
                                        <tbody>
                                             <c:forEach items="${flist}" var="file">
	                                            <tr>
													...
													<td><a class="btn btn-warning btn-sm remove_paper" id="file${file.id}">删除试卷</a></td>
	                                            </tr>
                                            </c:forEach> 
                                         </tbody>
	...
	<script type="text/javascript">
			$(function() {
				...
				$('.table tbody').on('click',".remove_paper" ,function () {
					...
					var result = "false";
					 if(confirm('确定要删除试卷吗?')) {
						 $.ajax({  
							 	type:"post",
						        url : path+"/file/removefile.do",// 请求的URL  
						        data : {  
						        	"id" : id  
						        },
						        async : false, // 改异步为同步  
				...
				$('.table tbody').on('click',".swfload" ,function () {
					var str = $(this).prop("id");
					var i = "file".length;
