							...
							<div class="col-xs-12">
								<div class="card">
									...
									<form class="form-horizontal" id="Login"
										action="${pageContext.request.contextPath}/admin/uploadquestion.do"
										method="post"
										...
										<div class="form-group">
											...
											<div class="col-sm-5">
												<a href="${pageContext.request.contextPath}/template/注意事项.doc" style="color:rgb(22,22,22);text-decoration: underline;">点击下载</a>
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-2 control-label">下载模板</label>
											<div class="col-sm-5">
												<a href="${pageContext.request.contextPath}/template/question.xlsx" style="color:rgb(22,22,22);text-decoration: underline;">点击下载</a>
											</div>
										</div>
										<div class="form-group">
